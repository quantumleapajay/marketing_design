...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("mt-auto flex flex-row flex-wrap justify-end gap-2 px-5 py-3 border-t border-gray-100", className)}
      {...props}
    />
  )
}
...
function SheetTitle({ className, ...props }: SheetPrimitive.Title.Props) {
  return (
    <SheetPrimitive.Title
      ...
      className={cn(
        "font-heading text-base font-semibold text-gray-900",
        className
      )}
      {...props}
    />
